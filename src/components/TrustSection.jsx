...
const trust = [
  { Icon: IconLock,    label: 'SSL Dienkripsi' },
    ...
    <section className="py-12 px-6">
      ...
      <div className="max-w-md mx-auto">
        ...
        >
          ...
          <p className="font-body text-ice/40 text-sm mt-1">Berlesen &amp; Dikawal Selia · Malaysia</p>
        </motion.div>
        ...
        >
          18+ sahaja. Main bertanggungjawab. i88 menyokong permainan selamat di Malaysia.
