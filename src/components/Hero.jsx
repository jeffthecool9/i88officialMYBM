...
const stats = [
  { value: '3X',   label: 'Top Up RM100 · Dapat RM300' },
  { value: '20%',  label: 'Harian · Maks RM288/Hari'   },
  { value: 'RM5K', label: 'Hadiah Pas Mingguan'         },
]
      ...
      <div className="relative z-10 flex flex-1 items-end pb-20">
        ...
        >
          ...
          <motion.div variants={rise} className="flex md:justify-start justify-center mb-4">
            <PremiumButton
              size="lg"
              onClick={() => { trackEvent('hero_cta_click', { section: 'hero' }); window.open('https://www.palacehub8.com/VOfRfnuO', '_blank') }}
